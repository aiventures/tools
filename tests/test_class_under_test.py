...
# unittests in tests subfolder will be collected. tests also requires a __init__.py file
# run all unittests in root directory ../tools using: 
# pytest -s -v ./tests/test_class_under_test.py
