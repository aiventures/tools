...
from tools.yaml_analyzer.recurse_dict import DictParser
from tools.yaml_analyzer.persistence_helper import PersistenceHelper
from tools.yaml_analyzer.configpath import TEST_CONFIG,VALIDATION_REPORT
...
class YamlAnalyzer():
    ...
    def get_config_element(self,*args,info:bool=False):
        ...
        if not info:
            ...
            return {"VALUE":out,LEAF_DICT:leaf_dict,LINE_KEY:min_line}
    ...
    def get_category(self,_leaf,_leaf_info,_config_element):
...
class MarkDownRenderer():
    ...
    def create_report(self)->list:
        ...
        for _file,category_info in self._md_dict.items():
            for _category,md_info in category_info.items():
