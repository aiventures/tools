...
echo                            code_inspector, plantuml, tc, venv_work 
echo * tc [right_folder]        opens total commander at current location 
echo                            optionally [right_folder] for right view
echo * venv_work                activates VENV [venv_work}
